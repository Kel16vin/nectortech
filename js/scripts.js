...
const SERVICES = [
  ...
  {ic:'building', title:'Building Construction', short:'Residential, commercial and institutional builds, managed on site.', long:'From groundbreaking to finishing, we manage labour, materials and sequencing on site, with quality and safety checks built into every stage of the build.', tags:['Residential','Commercial','Site supervision'], img:'https://images.unsplash.com/photo-1555099101-dbcd95eec387?auto=format&fit=crop&w=800&q=80', fullImg:'https://images.unsplash.com/photo-1662814439140-82b59abfce42?auto=format&fit=crop&w=800&q=80'},
  ...
  {ic:'manage', title:'Project Management', short:'One accountable team tracking cost, schedule and quality.', long:'Independent oversight of contractors, budgets and timelines — giving clients a single point of contact who is accountable for the project reaching handover on spec.', tags:['Scheduling','Budget control','Contractor oversight'], img:'https://images.unsplash.com/photo-1771971015617-db6bfb2f1e83?auto=format&fit=crop&w=800&q=80', fullImg:'https://images.unsplash.com/photo-1775880303572-791fbbb73d32?auto=format&fit=crop&w=800&q=80'},
